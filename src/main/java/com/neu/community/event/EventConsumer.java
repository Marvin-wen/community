package com.neu.community.event;
...
public class EventConsumer implements CommunityConstant {
    ...
    public void handleCommentMessage (ConsumerRecord<String, Event> record) {
    ...
    public void handlePublishMessage(ConsumerRecord<String, Event> record) {
        if (record == null || record.value() == null) {
            logger.error("消息内容为空！");
            return;
        }
